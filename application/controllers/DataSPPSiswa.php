...
class DataSPPSiswa extends CI_Controller
{
	...
	public function tampildata()
	{
		...
		$data['nominal_spp'] = $result->nominal_spp;
	...
	public function ubah($kd)
	{
		...
		$this->form_validation->set_rules("nmnl_spp", "Nominal", "required");
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$nominal = $this->input->post('nmnl_spp');
			$jumlah = $this->input->post('jmlh_angsuran');
			$nominal_angsuran =  $nominal / $jumlah;
			$this->SPPSiswa_Model->ubah_data($nominal_angsuran);
